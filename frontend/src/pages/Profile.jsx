...
const Profile = () => {
  ...
  /* ---------- UI ---------- */
  return (
  <div className="min-h-screen w-full bg-neutral-900 px-6 py-10">
    {/* PAGE HEADER */}
    ...
    {loading ? (
      <p className="text-neutral-400 text-center">Loading profile...</p>
    ) : (
      <div className="max-w-5xl mx-auto bg-neutral-800 border border-neutral-700 rounded-2xl p-8 space-y-6">
        <div>
